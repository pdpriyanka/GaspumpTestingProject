public class GasPump {
	...
	// This method return the current state value
	...
	//This method displays values of all variables and also display current state
	public void Show_AllVariables(){
		String state = "S"+k;
		if(k == 5 && w == 1){			
			state = "S"+1;
		}
		...
		System.out.println(" Current State = " +state+" state");
		System.out.println(" Price of Regular Gas = "+Rprice);
		System.out.println(" Price of Super Gas = "+Sprice);
		System.out.println(" Price of Diesel = "+Dprice);		
		System.out.println(" Price of selected gas or fuel = "+price);
		System.out.println(" Value of w = "+w);
		System.out.println(" Value of k = "+k);
		System.out.println(" Cash = "+ cash);
		System.out.println(" Number of liter(s) = "+L);
